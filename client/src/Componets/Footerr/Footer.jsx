    ...
    <div>
      <footer className="bg-gray-800 text-white">
        <div className="container px-6 py-12 mx-auto">
          <div className="grid grid-cols-2 gap-6 mt-12 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6">
            <div>
              ...
              <div className="flex flex-col items-start mt-4 space-y-4">
                <p className="transition-colors duration-200 dark:hover:text-blue-400 hover:underline hover:text-blue-600">
                  New York
                </p>
                <p className="transition-colors duration-200 dark:hover:text-blue-400 hover:underline hover:text-blue-600">
                  Los Angeles
            ...
            <div>
              ...
              <div className="flex flex-col items-start mt-4 space-y-4">
                <a
                  href="/"
                  className="transition-colors duration-200 dark:hover:text-blue-400 hover:underline hover:text-blue-600"
                >
                  Blog
                </a>
                <a
          ...
          {/* Horizontal layout for the bottom section */}
          ...
          <div className="flex flex-col items-center justify-between sm:flex-row mt-8">
